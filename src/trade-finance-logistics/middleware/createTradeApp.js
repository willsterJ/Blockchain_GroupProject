...
.then(() => {
	...
	return invokeCC.invokeChaincode(Constants.BUYER_ORG, Constants.CHAINCODE_VERSION, 'requestTrade', ['2ks89j9', '50000','Wood for Toys'], 'Importer');
}, (err) => {
	console.log('\n');
	console.log('------------------------------');
...
.then(() => {
	...
	return queryCC.queryChaincode(Constants.SELLER_ORG, Constants.CHAINCODE_VERSION, 'getTradeStatus', ['2ks89j9'], 'Exporter');
}, (err) => {
	console.log('\n');
	console.log('-----------------------------');
