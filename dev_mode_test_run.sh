...
# sleep 2
peer chaincode invoke -n tw -c '{"Args": ["requestStorage", "store-1", "war-1", "item-1", "0.08"]}' -C tradechannel
sleep 5
peer chaincode invoke -n tw -c '{"Args": ["acceptStorage", "store-1"]}' -C tradechannel
# sleep 5
# peer chaincode invoke -n tw -c '{"Args": ["requestAdvertisement", "adv-1", "mid-1", "item-1", "0.08"]}' -C tradechannel
# sleep 5
